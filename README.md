...
_G.SaveSetting = {
   ...
   function LoadSettings()
	   ...
	   if readfile and writefile and isfile and isfolder then
		   ...
		   if not isfolder("chicken Hub Premium Scripts") then

			   makefolder("chicken Hub Premium Scripts")

		   end

		   if not isfolder("chicke Hub Premium Scripts/Blox Fruits/") then

			   makefolder("chicken Hub Premium Scripts/Blox Fruits/")

		   end

		   if not isfile("chicken HubPremium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then

			   writefile("chicken HubPremium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.SaveSetting))
